...
class Application:
    ...
    def update_gui(self):
        ...
        def add_building(building):
            ...
            self.buildings_tree.insert('', self.__amount_of_buildings, building.name, text=building.name,
                                       values=values)
    ...
    def update_periodic(self):
        ...
        def update_queue():
            ...
            if len(items) > 0 and len(self.game.current_planet.buildings_queue.buildings_queue) > 0:
                ...
                next_building = self.game.current_planet.buildings_queue.buildings_queue[0]
                self.buildings_queue_tree.insert('', 0, next_building.name, text=next_building.name,
                                                 values=[str(next_building.level),
